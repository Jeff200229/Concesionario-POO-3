...
public class Concesionario {
    ...
    public void registarVehiculo(String tipo_vehiculo, String placa_vehiculo, String marca, String referencia, String modelo, int num_ruedas, double precio, boolean disponible) {
        ...
        if (tipo_vehiculo.equals("auto") || tipo_vehiculo.equals("Auto")) { //Condición que selecciona
            ...
            auto.setNumero_Ruedas(num_ruedas);
            ...
            moto.setModel(modelo);
            moto.setNumero_Ruedas(num_ruedas);
            ...
            camion.setModel(modelo);
            camion.setNumero_Ruedas(num_ruedas);
    ...
    public void buscarVehiculo(String opcion_referencia){
        ...
        for (int i=0; i< vehiculos.size(); i++) { //Ciclo que recorre el arraylist
            ...
            if(!vehiculos.isEmpty()){
                if(opcion_referencia.equals(vehiculos.get(i).getPlaca()) || opcion_referencia.equals(vehiculos.get(i).getMarca()) || opcion_referencia.equals(vehiculos.get(i).getReferencia()) || opcion_referencia.equals(vehiculos.get(i).getModel()) || opcion_referencia.equals(precio_vehiculo)){
                    System.out.println("Tipo de vehículo: "+vehiculos.get(i).getTipo_Vehiculo()+" Placa: "+vehiculos.get(i).getPlaca()+" Marca: "+vehiculos.get(i).getMarca()+" Referencia: "+vehiculos.get(i).getReferencia()+" Modelo: "+vehiculos.get(i).getModel()+" Número de ruedas: "+vehiculos.get(i).getNumero_Ruedas()+" Precio: "+vehiculos.get(i).getPrecio()+" Disponibilidad: "+vehiculos.get(i).isDisponible());
                }else{
            ...
            if(!vehiculos.isEmpty()){
                if (vehiculo.isDisponible()){
                   String estado = "Disponible";
                    System.out.println("Estado: "+estado+" Marca: "+vehiculo.getMarca()+" Referencia: "+vehiculo.getReferencia()+" Modelo: "+vehiculo.getModel()+" Número de ruedas: "+vehiculo.getNumero_Ruedas()+" Precio: "+vehiculo.getPrecio());
                }
            }
        }
    }
    ...
    public void mostrarCantidadVehiculos(){
        ...
        for (Vehiculo vehiculo:vehiculos){
            if (!vehiculos.isEmpty()){
                if(vehiculo.isDisponible()){
                    String estado = "Disponible";
                    System.out.println("Estado: "+estado+" Tipo de vehículo "+vehiculo.getTipo_Vehiculo()+" Marca: "+vehiculo.getMarca()+" Referencia: "+vehiculo.getReferencia()+" Modelo: "+vehiculo.getModel()+" Número de ruedas: "+vehiculo.getNumero_Ruedas()+" Precio: "+vehiculo.getPrecio());
                    stock++;
                }else {
        ...
        if(tipo_vehiculo == 1){
            ...
            for (Vehiculo vehiculo:vehiculos){
                if (vehiculo.getReferencia().equals(referencia)){
                    ...
                    vehiculo.setNumero_Ruedas(numero_ruedas);
